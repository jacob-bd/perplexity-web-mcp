/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-success-factors-api@1.1.7@prelib', {"name":"wm-plugin-success-factors-api","version":"1.1.7","toolbelt":"2.0.2","packageDate":"2025-08-29T06:41:12.734Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
__webpack_require__(897)(getLego);
...
var ODataApi = /** @class */ (function () {
    ...
    ODataApi.prototype.getUserRoles = function () {
        var params = {
            ...
            filter: "userId eq '" + this._userMetadata.userId + "'"
        };
...
Lego.ctx.register('SuccessFactorsApiVersion').asInstance('1.1.7');
...
var wait = __webpack_require__(410)(Lego.ctx);
...
var PasteDecorator = /** @class */ (function () {
    ...
    PasteDecorator.prototype.decorateText = function () {
        try {
            ...
            var jsonSettings_1 = customSettings ? customSettings.sufaSearchBarPaste : null;
            var _this_1 = this;
            inputGenerator.text = function text(element, txt, reactionTime, callback, step, keepFocus, shouldSubmitInput) {
                try {
                    ...
                    if (_this_1.isVega(element[0])) {
                        _this_1._sfLogger.info('Skipping decoration for Vega search bar and setting enter to false');
                        return originalText_1(element, txt, reactionTime, callback, step, keepFocus, false);
                    }
                    if (jsonSettings_1 && jsonSettings_1.enabled && !isDatePicker && _this_1.checkSearchBar(element[0], jsonSettings_1)) {
                    ...
                    else if (jsonSettings_1 && !jsonSettings_1.disableDatePicketTyping && isDatePicker) {
    ...
    PasteDecorator.prototype.checkSearchBar = function (element, jsonSettings) {
        var defaultSeachBarCheck = element.classList.value.indexOf('ui5-input-inner') !== -1;
        var searchBarId = jsonSettings.ID;
        var searchBarSelector = jsonSettings.selector;
        var isInput = this.isInput(element);
    ...
    PasteDecorator.prototype.queryElement = function (selector) {
        return Lego.ctx.has('JQueryElementFinder') ? Lego.ctx.get('JQueryElementFinder').findElementsByjQueryComplexSelector(selector)[0] : wmjQuery(selector)[0];
    };
