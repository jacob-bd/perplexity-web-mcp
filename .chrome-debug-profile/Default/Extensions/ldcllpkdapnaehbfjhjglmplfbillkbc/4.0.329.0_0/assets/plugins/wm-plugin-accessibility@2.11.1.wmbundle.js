/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-accessibility@2.11.1@prelib', {"name":"wm-plugin-accessibility","version":"2.11.1","toolbelt":"2.0.2","packageDate":"2025-03-17T12:50:06.546Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
var getCtx = (__webpack_require__(6179)/* .getCtx */ .yK);
var tabIndexHandler = __webpack_require__(8423);
...
getCtx().register('SmartTipAccessibilityHandler')
    ...
    .dependencies('WmAccessibilityCommonUtils, CommonUtils, wmjQuery, TimerManager, SmartTipFocusHandler, BBCodeParser, ' +
        ...
        'FocusLockChecker, AccessibilityConsts, ElementsGetter, SmartTipExistenceChecker, ' +
...
function SmartTipAccessibilityHandler(wmAccessibilityCommonUtils, commonUtils, wmjQuery, timerManager, smartTipFocusHandler, bbcodeParser,
    ...
    _this.init = function init(deployablesRoles, deployablesAriaLabels) {
        if (featuresManager.isFeatureEnabled(accessibilityConsts.FEATURES.DisableSmartTipsAccessibility) || !smartTipExistenceChecker.doSmartTipsExist()) {
            return;
        }
...
var createPluginEntry = (__webpack_require__(6179)/* .createPluginEntry */ .mJ);

module.exports = createPluginEntry(function(registerPlugin) {
	__webpack_require__(9694);
	...
	__webpack_require__(8457);

	var Accessibility = (__webpack_require__(608)/* .Accessibility */ .h);
...
getCtx().register('SmartTipExistenceChecker')
    .asCtor(SmartTipExistenceChecker)
    .dependencies('BusinessSolutionsManager');

function SmartTipExistenceChecker(businessSolutionsManager) {
    var _this = this;

    _this.doSmartTipsExist = doSmartTipsExist;

    function doSmartTipsExist() {
        var businessSolutions = businessSolutionsManager.getDeployablesDict();

        for (var deployableId in businessSolutions) {
            if (businessSolutions[deployableId].SmartTips && businessSolutions[deployableId].SmartTips.length > 0) {
                return true;
            }
        }
...
getCtx().register('WmAccessibilityInitializer')
	...
	.dependencies('FeaturesManager, CommonUtils, WmAccessibilityCss, BizFlowAccessibilityHandler, ' + 
		...
		'ShoutoutVisualDesignAccessibilityHandler, DebuggerAccessibilityHandler');

function WmAccessibilityInitializer(featuresManager, commonUtils, wmAccessibilityCss, bizFlowAccessibilityHandler, 
		launcherAccessibilityHandler, resourceAccessibilityHandler, shoutoutAccessibilityHandler,
		smartTipAccessibilityHandler, surveyAccessibilityHandler, walkThruAccessibilityHandler,
        shuttleAccessibilityHandler, menuAccessibilityHandler, wmAccessibilityCommonUtils, bbCodeAccessibilityHandler,
		ballonCreatedAccessibilityHandler, textsTranslator, iframeTabOrderWrapper, liveChatAccessibilityHandler, shoutoutVisualDesignAccessibilityHandler, debuggerAccessibilityHandler) {
	var _this = this;
...
/******/ 	var __webpack_exports__ = __webpack_require__(8628);
