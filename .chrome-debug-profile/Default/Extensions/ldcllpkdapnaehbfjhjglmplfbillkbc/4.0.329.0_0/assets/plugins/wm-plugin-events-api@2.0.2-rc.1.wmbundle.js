/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-events-api@2.0.2-rc.1@prelib', {"name":"wm-plugin-events-api","version":"2.0.2-rc.1","toolbelt":"2.0.2","packageDate":"2025-04-22T08:13:55.432Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
module.exports = __webpack_require__(4702);
...
module.exports = {
    services: __webpack_require__(4070),
    servicesWithDependencies: __webpack_require__(4463)
};
...
var deployableConsts = __webpack_require__(1792)();
...
module.exports = {
    conditionValidator: __webpack_require__(5049),
    cssForbiddenTokensChecker: __webpack_require__(7191),
    consts: __webpack_require__(8),
    guidGenerator: __webpack_require__(8772),
    htmlEscaper: __webpack_require__(2742),
    jsonUtils: __webpack_require__(8577),
    offsetByPositionAndContextProvider: __webpack_require__(5832),
    offsetByPositionAndContextUpdater: __webpack_require__(2764),
    parallelExecutor: __webpack_require__(8462),
    stepDtoCategory: __webpack_require__(8313),
    timer: __webpack_require__(4395),
    trackedPageDefaultTreeService: __webpack_require__(1103),
    trackedSimplePageByConditionFinder: __webpack_require__(2511),
    onPageElementActionsProvider: __webpack_require__(6072),
    inputEventsRaiser: __webpack_require__(8237),
    pageElementTagActions: __webpack_require__(4580),
    deployableTypes: __webpack_require__(8142)
};
...
var _jsonUtils = __webpack_require__(5975);
...
var offsetByPositionAndContextProvider = __webpack_require__(5832);
...
var platforms = (__webpack_require__(8).PLATFORMS);
var onPageActionType = (__webpack_require__(5356).onPageActionType);
var platformsFilterer = new (__webpack_require__(1903))();
var pageElementTagActions = __webpack_require__(4580);
...
var trackedPageDefaultTreeService = __webpack_require__(1103);
...
var pipeRunnerFactory = __webpack_require__(5058);
...
module.exports = {
    canvasCreator: __webpack_require__(5711),
    dataEncodingService: __webpack_require__(2759),
    dtoMapper: __webpack_require__(2251),
    passOwnershipManager: __webpack_require__(438),
    siteConfigPrepareService: __webpack_require__(8844),
    multiTriggersUpdater: __webpack_require__(2334),
    exceptionMessageFormatter: __webpack_require__(6277)
};
...
var cssForbiddenTokensChecker = __webpack_require__(7191);
...
module.exports = {
    wmJson: __webpack_require__(3185),
    toJsonFixer: __webpack_require__(4266)
};
...
var log = (__webpack_require__(4387)/* .log */ .R);
var eventsListener = __webpack_require__(5967);
...
var getCtx = (__webpack_require__(8460)/* .getCtx */ .yK);
var eventMaps = [];
var map = {};

eventMaps.push(__webpack_require__(1416));
eventMaps.push(__webpack_require__(7899));
eventMaps.push(__webpack_require__(5446));
eventMaps.push(__webpack_require__(4107));
eventMaps.push(__webpack_require__(7288));
eventMaps.push(__webpack_require__(5419));
eventMaps.push(__webpack_require__(3034));
eventMaps.push(__webpack_require__(9173));
eventMaps.push(__webpack_require__(187));
eventMaps.push(__webpack_require__(6614));
eventMaps.push(__webpack_require__(4572));
eventMaps.push(__webpack_require__(7000));
...
function EventsApi() {
	...
	function run() {
		...
		eventsListener.on('BeforeWalkmeReady', function () {
			...
			__webpack_require__(4396)(window.WalkMeAPI);
...
var getCtx = (__webpack_require__(8460)/* .getCtx */ .yK);
var mapper = __webpack_require__(102);
var store = __webpack_require__(986);
...
var createPluginEntry = (__webpack_require__(8460)/* .createPluginEntry */ .mJ);

module.exports = createPluginEntry(function (registerPlugin) {
	var EventsApi = (__webpack_require__(3536)/* .EventsApi */ ._);
...
var getCtx = (__webpack_require__(8460)/* .getCtx */ .yK);
var log = (__webpack_require__(4387)/* .log */ .R);
var dtoMapper = __webpack_require__(4013);
var eventsMap = __webpack_require__(1058);
...
var log = (__webpack_require__(4387)/* .log */ .R);
var mapper = __webpack_require__(102);
var eventsBase = __webpack_require__(3721);
...
var getCtx = (__webpack_require__(8460)/* .getCtx */ .yK);
var editorPageScriptSharedServices = __webpack_require__(5605);
...
var conditionBuilderPreview = new (__webpack_require__(1209));
var drawablePosition = new (__webpack_require__(7560));
var stepTrigger = new (__webpack_require__(4391));
var stepType = new (__webpack_require__(4459));
var entityType = new (__webpack_require__(5878));
var surveyQuestionType = new (__webpack_require__(8275));
var contentType = new (__webpack_require__(7132));
var designTemplateType = new (__webpack_require__(5309));
var smarttipMode = new (__webpack_require__(2300));
var stickinessType = new (__webpack_require__(9293));
var flowNodeType = new (__webpack_require__(4321));
var searchProvider = new (__webpack_require__(8568));
var screenshotMode = new (__webpack_require__(7874));
var scrollType = new (__webpack_require__(252));
var deployableGroupType = new (__webpack_require__(8003));
var teachMeCompletionType = new (__webpack_require__(948));
var teachMeQuestionType = new (__webpack_require__(5430));
var templateEntityType = new (__webpack_require__(792));
var designTemplateDefaultFieldText = new (__webpack_require__(7541));
var defaultSelectors = new (__webpack_require__(5840));
var editorCommunication  = new (__webpack_require__(6162));
var publishEnvironment = new (__webpack_require__(301));
var userType = new (__webpack_require__(4770));
var onPageActionType = new (__webpack_require__(6545));
var designTemplateCategory = new (__webpack_require__(4549));
var deployableDefaultAttributes = new (__webpack_require__(5496));
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"SurveyStarted":{"libEventName":"StartSurvey","paramsMap":{"data.surveyJson.Id":"id","data.surveyJson.Name":"name"}},"SurveySubmitted":{"libEventName":"SurveyCompleted","paramsMap":{"data.status":"status"}}}');
