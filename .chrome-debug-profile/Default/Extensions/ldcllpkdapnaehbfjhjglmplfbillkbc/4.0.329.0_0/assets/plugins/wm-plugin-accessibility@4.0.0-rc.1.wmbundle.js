/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-accessibility@4.0.0-rc.1@prelib', {"name":"wm-plugin-accessibility","version":"4.0.0-rc.1","toolbelt":"2.0.2","packageDate":"2025-11-24T12:01:13.924Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
var getCtx = (__webpack_require__(5164)/* .getCtx */ .yK);
var tabIndexHandler = __webpack_require__(5814);
...
getCtx().register('DummyTabOrganizer')
    ...
    .dependencies('DefaultTextGetter, Positions, EventHandlerBindingManager, AccessibilityUtils, AccessibilityConsts, HostData, wmjQuery,' +
        'ElementEmbedderFactory, Consts, DomManager, JQueryElementFinder, FeaturesManager, JQuerySelectorRunner');
...
var createPluginEntry = (__webpack_require__(5164)/* .createPluginEntry */ .mJ);

module.exports = createPluginEntry(function(registerPlugin) {
	__webpack_require__(1613);
	__webpack_require__(6277);
	__webpack_require__(456);
	__webpack_require__(9226);
	__webpack_require__(7251);
	...
	var Accessibility = (__webpack_require__(6047)/* .Accessibility */ .h);
...
function ElementsGetter(accessibilityUtils, accessibilityConsts, wmjQuery, smartTipElementsGetter, jQuerySelectorRunner, featuresManager) {
    ...
    function getShadowRootActiveELement() {
        ...
        while (true) {
            ...
            if (isSameDomainVisibleIframe(activeElement) &&
