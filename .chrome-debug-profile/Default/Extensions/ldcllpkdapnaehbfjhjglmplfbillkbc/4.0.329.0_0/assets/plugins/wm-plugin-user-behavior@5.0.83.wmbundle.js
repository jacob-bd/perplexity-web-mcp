/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-user-behavior@5.0.83@prelib', {"name":"wm-plugin-user-behavior","version":"5.0.83","toolbelt":"2.0.2","packageDate":"2026-01-08T22:37:03.524Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
var AbraDi = /** @class */ (function () {
    ...
    AbraDi.loadModules = function (ctx) {
        ctx.register('Abra:EventObfuscator').asCtor((__webpack_require__(848).Encoder)).dependencies('Abra:JSON');
        ctx.register('Abra:QueryGenerator')
            .asFunction(function (jQuery) {
            var jqueryProxy = __webpack_require__(497)({});
            var generator = __webpack_require__(25)(jQuery, jqueryProxy);
            return {
                generate: function (element) { return generator.generate(jQuery(element)); }
            };
        })
            .dependencies('wmjQuery');
        ctx.register('Abra:XpathEscaper').asInstance((__webpack_require__(820)/* .XpathEscaper */ .J));
    };
    AbraDi.classRegistrations = [];
    return AbraDi;
}());
...
module.exports = function create(options) {
	var jqueryGetter = new (__webpack_require__(615))(options);
	var jQueryProxy = new (__webpack_require__(254))(jqueryGetter, options);
	return jQueryProxy;
};
...
var createPluginEntry = (__webpack_require__(171)/* .createPluginEntry */ .mJ);

module.exports = createPluginEntry(function(registerPlugin) {
    var WmPluginAbra = (__webpack_require__(107)/* .WmPluginAbra */ .q);
...
var getCtx = (__webpack_require__(171)/* .getCtx */ .yK);

function WmPluginAbra() {
	this.run = run;

	function run() {
		return (__webpack_require__(892).start)(getCtx());;
	}
}
...
(function (QueryGenerator) {
    ...
    var illegalChars = ["'"];
    var SimpleNLP = __webpack_require__(853);
