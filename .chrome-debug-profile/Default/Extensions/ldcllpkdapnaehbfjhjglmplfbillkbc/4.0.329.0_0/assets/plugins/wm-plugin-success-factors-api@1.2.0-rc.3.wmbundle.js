/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-success-factors-api@1.2.0-rc.3@prelib', {"name":"wm-plugin-success-factors-api","version":"1.2.0-rc.3","toolbelt":"2.0.2","packageDate":"2026-01-30T15:16:11.362Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
__webpack_require__(931)(getLego);
...
Lego.ctx.register('SuccessFactorsApiVersion').asInstance('1.2.0-rc.3');
...
var wait = __webpack_require__(908)(Lego.ctx);
var SuccessFactors = /** @class */ (function () {
    ...
    SuccessFactors.prototype.childLogic = function () {
        var _this_1 = this;
        var languageResolverWrapper;
        wait.registerFunction(function (config) {
            var customSettings = Lego.ctx.get('SiteConfigManager').get().Custom;
            var parentOnly = customSettings ? customSettings.sufaParentOnly : null;
            if (parentOnly) {
                _this_1._sfLogger.info('Loading as parent only');
                return _this_1.parentLogic();
            }
            else {
                return new Promise(function (resolve) {
                    languageResolverWrapper = function (event) {
                        try {
                            ...
                            _this_1._sfLogger.info('Error on child initialization: ', error);
                        }
                    };
                    window.addEventListener('message', languageResolverWrapper);
