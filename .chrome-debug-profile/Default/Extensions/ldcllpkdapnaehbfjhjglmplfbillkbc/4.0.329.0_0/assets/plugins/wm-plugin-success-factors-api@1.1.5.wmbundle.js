/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-success-factors-api@1.1.5@prelib', {"name":"wm-plugin-success-factors-api","version":"1.1.5","toolbelt":"2.0.2","packageDate":"2025-08-05T07:44:02.149Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
__webpack_require__(925)(getLego);
...
Lego.ctx.register('SuccessFactorsApiVersion').asInstance('1.1.5');
...
var wait = __webpack_require__(710)(Lego.ctx);
...
var PasteDecorator = /** @class */ (function () {
    ...
    PasteDecorator.prototype.decorateText = function () {
        try {
            ...
            inputGenerator.text = function text(element, txt, reactionTime, callback, step, keepFocus, shouldSubmitInput) {
                try {
                    if (jsonSettings_1 && jsonSettings_1.enabled && _this_1.checkSearchBar(element[0], jsonSettings_1)) {
                        _this_1._sfLogger.info('Decorating text injection for search bar');
                        return _this_1.useSuFaSearchBarPaste(element[0], txt, callback, shouldSubmitInput ? _this_1.enter : function () { });
                    }
                }
                catch (error) {
    ...
    PasteDecorator.prototype.checkSearchBar = function (element, jsonSettings) {
        ...
        return isInput && ((searchBarId && element.id === searchBarId) || (!searchBarId && defaultSeachBarCheck));
    };
