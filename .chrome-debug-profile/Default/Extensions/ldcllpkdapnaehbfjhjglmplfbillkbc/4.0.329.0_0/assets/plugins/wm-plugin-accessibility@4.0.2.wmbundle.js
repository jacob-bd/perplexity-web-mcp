/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-accessibility@4.0.2@prelib', {"name":"wm-plugin-accessibility","version":"4.0.2","toolbelt":"2.0.2","packageDate":"2025-12-22T15:38:03.999Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
var getCtx = (__webpack_require__(5807)/* .getCtx */ .yK);
var tabIndexHandler = __webpack_require__(7867);
...
function SmartTipAccessibilityHandler(wmAccessibilityCommonUtils, commonUtils, wmjQuery, timerManager, smartTipFocusHandler, bbcodeParser,
    ...
    function handleSmartTipIconElementAnnouncement(smartTipIconElement, smartTipText) {
        eventHandlerBindingManager.bind('keydown', function(event) {
            ...
            wmAccessibilityCommonUtils.announce(smartTipText);
        }, smartTipIconElement);
...
var createPluginEntry = (__webpack_require__(5807)/* .createPluginEntry */ .mJ);
...
module.exports = createPluginEntry(function(registerPlugin) {
	...
	var Accessibility = (__webpack_require__(8604)/* .Accessibility */ .h);
...
/******/ 	var __webpack_exports__ = __webpack_require__(5008);
