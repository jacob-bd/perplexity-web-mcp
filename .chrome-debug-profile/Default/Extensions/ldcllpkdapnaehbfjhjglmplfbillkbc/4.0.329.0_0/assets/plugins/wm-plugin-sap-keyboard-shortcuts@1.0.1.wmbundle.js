/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-sap-keyboard-shortcuts@1.0.1@prelib', {"name":"wm-plugin-sap-keyboard-shortcuts","version":"1.0.1","toolbelt":"2.0.2","packageDate":"2025-08-06T18:36:39.022Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
var createPluginEntry = (__webpack_require__(736)/* .createPluginEntry */ .mJ);

module.exports = createPluginEntry(function(registerPlugin) {
    var SapKeyboardShortcuts = (__webpack_require__(135)/* .SapKeyboardShortcuts */ .v);
...
var getCtx = (__webpack_require__(736)/* .getCtx */ .yK);
		...
		var keyboardShortcuts = shortcutsTree.map(function (item) {
			return {
				...
				shortcuts: item.nodes.map(function (node) {
					return {
						description: node.label.replace(/<[^>]*>/g, '').trim(),
