/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-success-factors-api@1.1.8@prelib', {"name":"wm-plugin-success-factors-api","version":"1.1.8","toolbelt":"2.0.2","packageDate":"2025-09-22T06:03:40.144Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
__webpack_require__(310)(getLego);
...
Lego.ctx.register('SuccessFactorsApiVersion').asInstance('1.1.8');
...
var wait = __webpack_require__(919)(Lego.ctx);
        ...
        try {
            ...
            inputGenerator.text = function text(element, txt, reactionTime, callback, step, keepFocus, shouldSubmitInput) {
                try {
                    ...
                    if (_this_1.isVega(element[0]) && jsonSettings_1 && jsonSettings_1.vega) {
                    ...
                    else if (jsonSettings_1 && jsonSettings_1.enabled && !isDatePicker && _this_1.checkSearchBar(element[0], jsonSettings_1)) {
