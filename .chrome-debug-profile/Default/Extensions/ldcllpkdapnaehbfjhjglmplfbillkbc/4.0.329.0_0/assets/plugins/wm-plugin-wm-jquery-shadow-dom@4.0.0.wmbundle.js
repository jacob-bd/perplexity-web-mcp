/* WalkMe Module */ typeof _walkmeInternals !== 'undefined' && _walkmeInternals.wmloader && _walkmeInternals.wmloader.define('wm-plugin-wm-jquery-shadow-dom@4.0.0@prelib', {"name":"wm-plugin-wm-jquery-shadow-dom","version":"4.0.0","toolbelt":"2.0.2","packageDate":"2025-04-27T14:29:15.686Z","entry":"prelib"}, function (__wmplugin__) {  
var wmbundle;
...
var arrUtils = __webpack_require__(837);
var wrapUtils = __webpack_require__(201)(wmjQuery);
...
var shadowVisibilityManager = __webpack_require__(977);
var iframeUtils = __webpack_require__(898);
...
var getCtx = (__webpack_require__(931)/* .getCtx */ .yK);
var arrUtils = __webpack_require__(837);
var iframeUtils = __webpack_require__(898);
var shadowContainerTypesMap = __webpack_require__(492);
var envTester = __webpack_require__(459);
var logger = __webpack_require__(566);
var getShadowPluginVersion = (__webpack_require__(767).getShadowPluginVersion);
...
function extendElementDescription(element, descriptionString, params) {
	...
	var jsonMock = __webpack_require__(875)(),
...
var shadowDomManagerCtor = __webpack_require__(383);
...
var getCtx = (__webpack_require__(931)/* .getCtx */ .yK);
var arrUtils = __webpack_require__(837);
var shadowContainerTypesOrder = __webpack_require__(177);
var elementUtils = __webpack_require__(848);
var querySelectorSpecialContent = __webpack_require__(990);
var hasNativeShadowDOM = (__webpack_require__(459).hasNativeShadowDOM);
var envTester = __webpack_require__(459);
var chunkSelector = __webpack_require__(836);
var shadowVisibilityManager = __webpack_require__(977);
var shadowUtils = __webpack_require__(642);

module.exports = function(wmjQuery, options) {
	var wrapUtils = __webpack_require__(201)(wmjQuery);
	var shadowManager = __webpack_require__(414)(options);
	...
	function bind() {
		...
		sizzle.sortOrder = (__webpack_require__(45).shadowSortOrder);
...
var getCtx = (__webpack_require__(931)/* .getCtx */ .yK);
var FEPlugin = __webpack_require__(426);
var overRidejQuery = __webpack_require__(40);
...
var arrUtils = __webpack_require__(837);
var shadowContainerTypesMap = __webpack_require__(492);
var shadowContextUtils = __webpack_require__(700);
var hasRelevantMutation = (__webpack_require__(217).hasRelevantMutation);
var shadowSortOrderManager = __webpack_require__(45);
var getCtx = (__webpack_require__(931)/* .getCtx */ .yK);
var isFeatureEnabled = (__webpack_require__(767).isFeatureEnabled);
var shadowUtils = __webpack_require__(642);
...
var elementUtils = __webpack_require__(848);
var shadowContainerTypesMap = __webpack_require__(492);
var adders = __webpack_require__(156);
var shadowVisibilityManager = __webpack_require__(977);
...
var createPluginEntry = (__webpack_require__(931)/* .createPluginEntry */ .mJ);
var getCtx = (__webpack_require__(931)/* .getCtx */ .yK);

module.exports = createPluginEntry(function(registerPlugin) {
	function getShadowDomClass(){		
		getCtx().register('ShadowPluginVersion').asInstance('4.0.0');
		var registerShadowToCtx = (__webpack_require__(936).registerToCtx);
		registerShadowToCtx(getCtx);
		var shadowDomClass = (__webpack_require__(761)/* .WmJqueryShadowDom */ .v);
